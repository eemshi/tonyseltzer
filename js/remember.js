...
function init() {
    var material1 = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load('./img/cassette-side2.jpg') });
    var material2 = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load('./img/cassette-side2.jpg') });
    var material3 = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load('./img/cassette-side1.jpg') });
    var material4 = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load('./img/cassette-side1.jpg') });
    var material5 = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load('./img/cassette-front.jpg') });
    var material6 = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load('./img/cassette-back.jpg') });
